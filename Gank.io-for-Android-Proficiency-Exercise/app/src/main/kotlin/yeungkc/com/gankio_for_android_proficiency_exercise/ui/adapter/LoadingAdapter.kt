...
abstract class LoadingAdapter : ArrayAutoBindAdapter() {
    ...
    override final fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder {
    ...
    abstract fun onCreateExViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder
    ...
    open fun onBindExViewHolder(holder: BaseViewHolder, position: Int) {
        super.onBindViewHolder(holder, position)
    }

    abstract class MsgViewHolder(view: View, event: (() -> Unit)? = null) : BaseViewHolder(view) {
        init {
